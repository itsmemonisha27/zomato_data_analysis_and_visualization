# -*- coding: utf-8 -*-
"""Zomato Data Analysis and  Visualization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1P6JttPm_89VbgLN2TDIhJQtGTVUrNgKX
"""
...
garamond_bold_style1 = "font-family: Garamond, sans-serif; font-weight: bold; color: red; font-size: 30px;"
garamond_bold_style2 = "font-family: Garamond, sans-serif; font-weight: bold; color: white; font-size: 25px;"

data = pd.read_csv(r'/content/zomato.csv')
